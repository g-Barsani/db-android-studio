...
public class TelaAlterarExcluir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int alunoId = Integer.parseInt(String.valueOf(edtId.getText()));
        ...
        btnExcluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TelaAlterarExcluir.this, "Aluno excluído com sucesso!", Toast.LENGTH_SHORT).show();
        ...
        btnAlterar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TelaAlterarExcluir.this, "Aluno alterado com sucesso!", Toast.LENGTH_SHORT).show();
